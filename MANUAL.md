# Manual Setup Steps for Minions Bundle: Content
...
Go to **GitHub → mxn2020/minions-bundles-content → Settings → Secrets and variables → Actions** and add:
...
### Web App (Playground)
- **Netlify site name**: `minions-bundles-content-web`
- **GitHub repo**: `mxn2020/minions-bundles-content`
...
### Documentation
- **Netlify site name**: `minions-bundles-content-docs`
- **GitHub repo**: `mxn2020/minions-bundles-content`
...
### Blog
- **Netlify site name**: `minions-bundles-content-blog`
- **GitHub repo**: `mxn2020/minions-bundles-content`
...
|--------|------|------|-------|
| Docs | CNAME | `content.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `content.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `content.minions.wtf` | _(Netlify subdomain)_ |
...
| Item | Value |
|------|-------|
| Project | `minions-bundles-content` |
| SDK (npm) | `undefined` |
| CLI (npm) | `undefined` |
| Python (PyPI) | `undefined` |
| GitHub | `github.com/mxn2020/minions-bundles-content` |
