...
/**
 * @minions-bundles-content/cli — CLI for Minions Bundle: Content
 *
...
import { bundleTypes as customTypes } from '@minions-bundles-content/sdk';
...
program
    ...
    .description('Content pipeline bundle — drafts, publications, channels, campaigns')
    .version('0.1.0');
...
program
    ...
    .action(() => {
        ...
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-bundles-content/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-bundles-content/cli')}`);
